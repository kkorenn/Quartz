...
internal static class PageImport {
    ...
    public static void Create(RectTransform parent) {
        ...
        GenerateUI.Localize(
            hintText,
            "IMPORT_HINT",
            "Pull your settings in from another ADOFAI mod. KorenResourcePack reads each supported mod " +
    ...
    private static void CreateOptionCard(SettingsImportOption option) {
        ...
        importBtn.Rect.AddToolTip(
            "DESC_IMPORT_DO",
            "Copy this mod's settings into KorenResourcePack. Settings it doesn't cover are left as they are."
        );
