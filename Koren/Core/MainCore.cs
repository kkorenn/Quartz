...
public static class MainCore {
    public static KorenRuntime Runtime { get; private set; }
    ...
    public static KorenLogger Log => Runtime.Logger;
    ...
    public static IKorenHost Host => Runtime.Host;
    ...
    public static void Initialize(IKorenHost host) {
        if(Runtime != null) {
            return;
        }

        Runtime = new KorenRuntime(host);
